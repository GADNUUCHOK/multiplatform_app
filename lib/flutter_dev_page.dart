...
class FlutterDevPage extends StatefulWidget {
  const FlutterDevPage({Key? key}) : super(key: key);

  @override
  State<FlutterDevPage> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<FlutterDevPage> {
  final TextEditingController _textEditingController = TextEditingController();
  late WebViewController _controllerWebView;

  bool get isMobile => platform == Platform.isIOS || Platform.isAndroid;
  ...
  void initState() {
    super.initState();
    kIsWeb ? platform = 'web' : platform = Platform.operatingSystem;
  }
          ...
          children: <Widget>[
            ...
            Flexible(
                child: isMobile
                    ...
                    //TODO desktop and web WebView
                // canLaunchUrlString(enterText)
            ),
            headerText == ''
                ? const SizedBox(
                    height: 0,
